...
def obtain_client(model):
    if model == 'gpt-4o-2024-08-06':
        ...
        from transformers import Qwen2_5_VLForConditionalGeneration, AutoTokenizer, AutoProcessor
        qwen25_vl = Qwen2_5_VLForConditionalGeneration.from_pretrained("~/autodl-tmp/model/Qwen2.5-VL-7B-Instruct", torch_dtype="auto", device_map="auto")
        processor = AutoProcessor.from_pretrained("~/autodl-tmp/model/Qwen2.5-VL-7B-Instruct")
        client = [processor, qwen25_vl]
