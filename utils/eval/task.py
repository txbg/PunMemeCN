...
def obtain_client(model):
    if model == 'gpt-4o-2024-08-06':
        ...
        qwen25_vl = Qwen2_5_VLForConditionalGeneration.from_pretrained("Qwen/Qwen2.5-VL-72B-Instruct", torch_dtype="auto", device_map="auto")
        processor = AutoProcessor.from_pretrained("Qwen/Qwen2.5-VL-72B-Instruct")
        client = [processor, qwen25_vl]
    elif model == 'qwen2.5-vl-7b-instruct':
        # Qwen2.5-VL-7B-Instruct
        from transformers import Qwen2_5_VLForConditionalGeneration, AutoTokenizer, AutoProcessor
        qwen25_vl = Qwen2_5_VLForConditionalGeneration.from_pretrained("Qwen2.5-VL-7B-Instruct", torch_dtype="auto", device_map="auto")
